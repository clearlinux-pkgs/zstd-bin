...
Source0  : https://github.com/facebook/zstd/releases/download/v1.5.7/zstd-1.5.7.tar.gz
Source1  : https://github.com/facebook/zstd/releases/download/v1.5.7/zstd-1.5.7.tar.gz.sig
Source2  : EF8FE99528B52FFD.pkey
...
Patch1: notrace.patch
Patch2: fopen-use-m.patch
Patch3: nolib.patch
Patch4: cflags.patch
Patch5: rsyncable-always.patch
...
grep -E '^\[GNUPG:\] (GOODSIG|EXPKEYSIG) EF8FE99528B52FFD' gpg.status
%setup -q -n zstd-1.5.7
cd %{_builddir}/zstd-1.5.7
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740070816
